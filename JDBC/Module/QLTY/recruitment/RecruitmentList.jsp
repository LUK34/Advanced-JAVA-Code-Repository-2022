...
<body>
	<div class="main-body-container">
		<form id="recruitmentForm">
			<span id="resultspanRecruit"> <input type="hidden" id="method"
				name="method" /> <%
 	int i = 0;
 %>
				<table class="fheading33" id="recruitList">
					...
					onkeyup="if(event.which == '13') { fetchRecruitListByCriteria(); }" /></th> -->
						<th><div align="center">
								<select id="recruit_patient_status"
									name="recruit_patient_status" class="text1"
									style="width: 100px;" onchange="fetchRecruitListByCriteria()">
